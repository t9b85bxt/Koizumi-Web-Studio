...
const SERVICES = [
  ...
  },
  {
    title: 'AI活用・文章整理の相談',
    note: '50,000円〜',
    desc: '問い合わせの自動応答、ブログ運用、社内文書の整理など、現場で使える小さなAI活用から一緒に整理し、導入まで伴走します。',
    includes: ['現状業務のヒアリング', '使いどころの整理・提案', '初期セットアップ', '使い方のレクチャー'],
  },
]
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 lg:py-24">
        <Reveal delay={0}>
          ...
          <p className="text-navy-600 mb-10">
            ホームページ制作から保守運用、ドメイン取得、AI活用の相談まで。お客さまの状況に合わせて柔軟に組み合わせられます。
          </p>
        </Reveal>
